...
$$ \mathcal{A} \vdash \mathcal{B} \Leftrightarrow \forall B \in \mathcal{B},\ \exists A \in \mathcal{A}:\ A \subset B,$$
and
$$ \mathcal{A} \prec \mathcal{B} \Leftrightarrow \forall A \in \mathcal{A},\ \exists B \in \mathcal{B}:\ A \subset B.
$$
